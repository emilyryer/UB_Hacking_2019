...
def generate_horoscope():
    ...
    forcast_prefix_list = ["Today, ", "It is highly unlikely that ", "It is almost certain that ", "You may be surprised to find out that ", "In the very near future, ", "It's not looking good for you when ", ]
    forcast_feeling_list = ["you will wake up feeling well-rested, ", "you will be sick, ", "you will meet your new best friend ", "you will experience rapid heart beat from all that red bull, ", "you will crash your laptop by running thirty processes at once, ", "you will wake up still feeling confident about your code, ", "you will not catch a cold or the flu from someone here, " , "your application will go down in flames during the demo", ]
    but = "but the stars will smile on you when "
    second_forecast_list = ["your teammates love you forever. ", "a mentor saves your failing project. ", "you feel better after nine cups of coffee. ", "you learn lots of new things. ", "you demo something fun, even you don't think it's very good. ", "you find out about some cool new job opportunities. ", "you get some awesome swag. ", "you get ice cream. ", "your judge really enjoys your project despite its obvious flaws. "]
